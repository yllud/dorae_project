 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
		// 원하는 버튼 이미지 크기로 수정
    	var buttonHeight = 60; // 버튼의 세로 크기 (픽셀 단위)
    
		//네이버 회원가입(인증)_커스텀 이미지로 버튼을 만들기 위해 추가
		
		    naver_id_login_contents = "<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='../resources/img/naverLogo.png' border='0' title='네이버 로그인' height='" + buttonHeight + "px'></a> ";
		} //커스텀 버튼 여기까지
		else 
		{
