	...
	<div class="d-flex flex-nowrap">
		<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				<li><button id="btnList" value="/dorae/admin/contact/list?page=1" class="nav-link text-white" aria-current="page" onclick="setActive(this)">공연 목록</button></li>
				<li><button id="btnInsert" value="/dorae/admin/faq/list?help_category_id=D01&page=1" class="nav-link text-white" onclick="setActive(this)">공연 추가 </button></li>
				<li><button id="btnDelete" value="/dorae/admin/faq/create" class="nav-link text-white" onclick="setActive(this)">삭제 공연 목록 </button></li>
			</ul>
			<hr>
