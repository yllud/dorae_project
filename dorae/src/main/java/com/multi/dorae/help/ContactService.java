...
import com.multi.dorae.admin.EmailSendRequest;
import com.multi.dorae.admin.RecipientForRequest;
...
public class ContactService {
	...
	public boolean answerUpdate(ContactVO vo) {
		...
		try {
			...
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(conns.getOutputStream(), Charset.forName("UTF-8")));
